...
const testimonials: Testimonial[] = [
  ...
  {
    name: "Kepala Desa Sebauk",
    role: "Pemerintah Desa Sebauk",
    image: "/kades.jpeg",
    quote:
  ...
  {
    name: "Ketua Kelompok Mangrove KEMPAS",
    role: "Pengelola Mangrove Desa Sebauk",
    ...
    <section className="bg-mist py-24 dark:bg-ink md:py-32">
      <div className="section-shell">
        <SectionHeader
          ...
          description="Ucapan dari tim, pemerintah desa, dan mitra pengelola mangrove yang menjalankan Program SELARAS bersama."
          align="center"
        />
          ...
          {testimonials.map((item, index) => (
            <Reveal key={item.name} delay={index * 0.1}>
              <div className="group flex flex-col items-center gap-6 rounded-lg border border-canopy/10 bg-white/76 p-7 text-center shadow-md transition-all duration-500 ease-[cubic-bezier(0.16,1,0.3,1)] hover:-translate-y-1 hover:border-ember/40 hover:shadow-glow dark:border-white/10 dark:bg-white/[0.06] sm:flex-row sm:text-left">
                <div className="relative h-28 w-28 shrink-0 overflow-hidden rounded-full border-4 border-white shadow-lg transition-transform duration-500 group-hover:scale-105 dark:border-white/10">
